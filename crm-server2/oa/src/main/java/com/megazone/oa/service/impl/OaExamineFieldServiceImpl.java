...
import com.megazone.oa.entity.PO.OaExamineData;
import com.megazone.oa.entity.PO.OaExamineField;
import com.megazone.oa.entity.PO.OaExamineFieldExtend;
import com.megazone.oa.mapper.OaExamineFieldMapper;
import com.megazone.oa.service.IOaExamineDataService;
import com.megazone.oa.service.IOaExamineFieldExtendService;
	...
	public List<OaExamineField> queryField(Integer id) {
		...
		if (ListUtil.toList(1, 2, 3, 4, 5, 6).contains(oaType)) {
			for (int i = 0; i < list.size(); i++) {
				...
				//TODO Translate logic for hashcode
				if (Objects.equals(oaType, 2) && "Approval Content".equals(field.getName())) {
					field.setName("Reason for leave");
				}
