...
import com.megazone.crm.mapper.CrmPrintTemplateMapper;
...
public class CrmPrintTemplateServiceImpl extends BaseServiceImpl<CrmPrintTemplateMapper, CrmPrintTemplate> implements ICrmPrintTemplateService {
	...
	public CrmPrintFieldVO queryFields(Integer crmType) {
		...
		if (crmEnum == CrmEnum.BUSINESS) {
			...
			businessList.add(new CrmModelFiledVO("business_name", "Opportunity Name"));
			businessList.add(new CrmModelFiledVO("money", "Opportunity Amount"));
			businessList.add(new CrmModelFiledVO("deal_date", "Estimated transaction date"));
			businessList.add(new CrmModelFiledVO("remark", "Remark"));
			businessList.add(new CrmModelFiledVO("type_name", "Opportunity Status Group"));
			businessList.add(new CrmModelFiledVO("status_name", "Opportunity Stage"));
			businessList.add(new CrmModelFiledVO("owner_user_name", "responsible person"));
			...
			contractList.add(new CrmModelFiledVO("num", "Contract Number"));
			contractList.add(new CrmModelFiledVO("name", "contract name"));
			contractList.add(new CrmModelFiledVO("money", "Contract Amount"));
			contractList.add(new CrmModelFiledVO("business_name", "Opportunity Name"));
			contractList.add(new CrmModelFiledVO("owner_user_name", "responsible person"));
			contractList.add(new CrmModelFiledVO("order_date", "order time"));
			contractList.add(new CrmModelFiledVO("start_time", "Contract start time"));
			contractList.add(new CrmModelFiledVO("end_time", "Contract end time"));
			contractList.add(new CrmModelFiledVO("contacts_name", "Customer Contractor"));
			contractList.add(new CrmModelFiledVO("company_user_name", "Company Contractor"));
			...
			contactsList.add(new CrmModelFiledVO("name", "name"));
			contactsList.add(new CrmModelFiledVO("sex", "gender"));
			contactsList.add(new CrmModelFiledVO("policymakers", "Is it a key decision maker"));
			contactsList.add(new CrmModelFiledVO("customer_name", "customer_name"));
			contactsList.add(new CrmModelFiledVO("mobile", "mobile"));
			contactsList.add(new CrmModelFiledVO("telephone", "telephone"));
			contactsList.add(new CrmModelFiledVO("email", "mailbox"));
			contactsList.add(new CrmModelFiledVO("post", "Title"));
			...
			receivablesList.add(new CrmModelFiledVO("number", "Collection Number"));
			...
			receivablesList.add(new CrmModelFiledVO("return_time", "Return date"));
			receivablesList.add(new CrmModelFiledVO("money", "Collection Amount"));
			receivablesList.add(new CrmModelFiledVO("return_type", "Collection method"));
			receivablesList.add(new CrmModelFiledVO("owner_user_name", "responsible person"));
			receivablesList.add(new CrmModelFiledVO("remark", "Remarks"));
	...
	private void getCustomerFields(CrmPrintFieldVO kv) {
		...
		customerList.add(new CrmModelFiledVO("source", "customer name"));
		customerList.add(new CrmModelFiledVO("industry", "customer name"));
		customerList.add(new CrmModelFiledVO("level", "customer name"));
		customerList.add(new CrmModelFiledVO("mobile", "mobile"));
		customerList.add(new CrmModelFiledVO("telephone", "telephone"));
		customerList.add(new CrmModelFiledVO("website", "URL"));
		customerList.add(new CrmModelFiledVO("email", "mailbox"));
		customerList.add(new CrmModelFiledVO("remark", "Remark"));
		customerList.add(new CrmModelFiledVO("detail_address", "detail_address"));
		customerList.add(new CrmModelFiledVO("address", "region"));
	...
	private void getProductFields(CrmPrintFieldVO kv) {
		...
		productList.add(new CrmModelFiledVO("category_name", "Product Category"));
		productList.add(new CrmModelFiledVO("unit", "unit"));
		productList.add(new CrmModelFiledVO("num", "Product Code"));
		productList.add(new CrmModelFiledVO("price", "standard price"));
		productList.add(new CrmModelFiledVO("sales_price", "selling price"));
		productList.add(new CrmModelFiledVO("sales_num", "quantity"));
		productList.add(new CrmModelFiledVO("discount", "discount"));
		productList.add(new CrmModelFiledVO("subtotal", "Total"));
		productList.add(new CrmModelFiledVO("discount_rate", "Whole order discount"));
		productList.add(new CrmModelFiledVO("total_price", "Total Product Amount"));
			...
			spanList.forEach(span -> {
				...
				if ("business".equals(model)) {
					...
					if (ObjectUtil.isEmpty(record.get(fieldName))) {
						...
						value = record.get(fieldName).toString();
					}
					...
					if (ObjectUtil.isEmpty(customer.get(fieldName))) {
						...
						value = customer.get(fieldName).toString();
					}
				}
				map.put(key, value);
			});
			...
			for (String span : spanList) {
				...
				if ("contract".equals(model)) {
					...
					if (ObjectUtil.isEmpty(contacts.get(fieldName))) {
						...
						value = contacts.get(fieldName).toString();
					}
				}
				map.put(key, value);
			}
			...
			spanList.forEach(span -> {
				...
				if ("receivables".equals(model)) {
					...
					if (ObjectUtil.isEmpty(contract.get(fieldName))) {
						...
						value = contract.get(fieldName).toString();
					}
				}
				map.put(key, value);
			});
			...
			for (JSONObject orderProduct : productList) {
				...
				spanList.forEach(span -> {
					...
					if (productFieldMap.containsKey(orderProduct.getString(fieldName))) {
						...
						getName(orderProduct.getInnerMapObject(), fieldName, formType);
					}
