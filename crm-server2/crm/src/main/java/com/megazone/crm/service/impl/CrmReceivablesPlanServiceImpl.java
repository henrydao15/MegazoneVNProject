...
public class CrmReceivablesPlanServiceImpl extends BaseServiceImpl<CrmReceivablesPlanMapper, CrmReceivablesPlan> implements ICrmReceivablesPlanService, CrmPageService {
	...
	public void exportExcel(HttpServletResponse response, CrmSearchBO search) {
		...
		ExcelParseUtil.exportExcel(dataList, new ExcelParseUtil.ExcelParseService() {
			...
			public void castData(Map<String, Object> record, Map<String, Integer> headMap) {
				...
				switch (Integer.parseInt(record.get("receivedStatus").toString())) {
					case 1:
						receivedStatus = "Payback completed";
						break;
					case 2:
						receivedStatus = "Partial Receipt";
						break;
					case 3:
						receivedStatus = "Void";
						break;
					case 4:
						receivedStatus = "Overdue";
						break;
					case 5:
						receivedStatus = "To be effective";
						break;
					default:
						receivedStatus = "Pending review";
				}
	...
	public void deleteByContractId(Integer contractId) {
		...
		List<Integer> ids = listObjs(queryWrapper, obj -> Integer.parseInt(obj.toString()));
		deleteByIds(ids);
	}
	...
	public List<FileEntity> queryFileList(Integer receivablesPlanId) {
		...
		if (crmFields.size() > 0) {
			...
			data.forEach(fileEntity -> {
				fileEntity.setSource("Repayment plan details");
