...
import com.megazone.crm.entity.BO.EsUpdateFieldBO;
import com.megazone.crm.entity.BO.EsUpdatePropertiesBO;
...
public class ElasticUtil {
	...
	public static void addField(RestHighLevelClient client, CrmFieldConfig crmField, Integer fieldType) {
		...
		try {
			...
			request.source(object.getInnerMapObject());
	...
	public static Map<String, Object> parseType(Integer type) {
		...
		switch (fieldEnum) {
			...
			case TEXTAREA:
				name = "text";
				map.put("fields", new JSONObject().fluentPut("sort", new JSONObject().fluentPut("type", "icu_collation_keyword").fluentPut("language", "ko").fluentPut("country", "KR"))
						.fluentPut("keyword", new JSONObject().fluentPut("type", "keyword")).getInnerMapObject());
				break;
			case SELECT:
				name = "keyword";
				break;
		...
		if ("keyword".equals(name)) {
			map.put("fields", new JSONObject().fluentPut("sort", new JSONObject().fluentPut("type", "icu_collation_keyword").fluentPut("language", "ko").fluentPut("country", "KR")).getInnerMapObject());
		}
		return map;
	}
